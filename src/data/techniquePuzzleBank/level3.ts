...
export const level3Puzzles: PartialPuzzleBank = {
  ...
  'jellyfish': [], // REMOVED: solver cannot solve this puzzle (hits iteration limit or gets stuck)
  ...
  'turbot-fish': [], // REMOVED: stored solution had zeros and duplicates; solver could not reproduce

  'empty-rectangle': [], // REMOVED: stored solution had zeros; solver could not reproduce

  'sue-de-coq': [], // REMOVED: solution was placeholder (identical to puzzle); solver could not reproduce

  'simple-colors': [], // REMOVED: stored solution had zeros and duplicate digits; solver could not reproduce
};
