...
describe("Technique Generator - Spike", () => {
  ...
  describe("Level 1 - Beginner", () => {
    test("should generate Naked Single puzzle", () => {
      ...
      console.log(
        `[Naked Single] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}`,
      );
    ...
    test("should generate Hidden Single puzzle", () => {
      ...
      console.log(
        `[Hidden Single] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}`,
      );
  ...
  describe("Level 2 - Intermediate", () => {
    test("should generate Naked Pair puzzle", () => {
      ...
      console.log(
        `[Naked Pair] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}`,
      );
    ...
    test("should generate Hidden Pair puzzle", () => {
      ...
      console.log(
        `[Hidden Pair] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}`,
      );
    ...
    test("should generate Pointing Pair puzzle", () => {
      ...
      console.log(
        `[Pointing Pair] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}`,
      );
    ...
    test("should generate Box/Line Reduction puzzle", () => {
      ...
      console.log(
        `[Box/Line Reduction] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}`,
      );
  ...
  describe("Level 3 - Advanced", () => {
    test("should attempt Naked Triple puzzle generation", () => {
      ...
      console.log(
        `[Naked Triple] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}, error=${result.error}`,
      );
    ...
    test("should attempt X-Wing puzzle generation", () => {
      ...
      console.log(
        `[X-Wing] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}, error=${result.error}`,
      );
  ...
  describe("Level 4 - Expert", () => {
    test("should attempt Swordfish puzzle generation", () => {
      ...
      console.log(
        `[Swordfish] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}, error=${result.error}`,
      );
    ...
    test("should attempt XY-Wing puzzle generation", () => {
      ...
      console.log(
        `[XY-Wing] success=${result.success}, time=${result.timeMs}ms, attempts=${result.attemptsTaken}, error=${result.error}`,
      );
...
describe("Technique Generator - Benchmark", () => {
  test("benchmark all techniques (3 trials each)", () => {
    ...
    for (const r of results) {
      const status =
        r.successRate >= 0.67 ? "GENERATE" : r.successRate > 0 ? "UNRELIABLE" : "CURATE";
    ...
    console.log(
      `Generate on-device: ${canGenerate.map((r) => r.techniqueName).join(", ") || "none"}`,
    );
    console.log(
      `Need curated bank: ${needCurated.map((r) => r.techniqueName).join(", ") || "none"}`,
    );
    console.log("");
